...
##############################################################################
#    $Source: /export/cvsroot/parser/inc/Attic/ms_shapiro_wilk.hpp,v $
#    $Author: davidc $ 
#      $Date: 2008-09-05 12:49:37 $ 
#  $Revision: 1.1.2.3 $
##############################################################################
*/
/*
...
namespace matrix_science {
    ...
    public:
        ...
        //! The Shapiro-Wilk W test - this constructor can only be called from C++
	    ms_shapiro_wilk(std::deque<std::pair<size_t,double> > x, long n, long n1, long n2);

        //! Calculate results using values previously added using appendXvalue
