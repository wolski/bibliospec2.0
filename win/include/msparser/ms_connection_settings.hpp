...
#                                                                            #
##############################################################################
#    $Source: /export/cvsroot/parser/inc/ms_connection_settings.hpp,v $ #
#     $Author: davidc $                                                      #
...
namespace matrix_science {
    ...
    /*! 
     * Proxy server and sessionID parameters may be required to access
     ...
     * <li>ms_unimod::ms_unimod(const char* filename, const ms_connection_settings * cs)</li>
    ...
    public:
        ...
        *  <tt>$x = $msparser::ms_connection_settings::PROXY_TYPE_FROM_REGISTRY</tt>
        *  </P><BR>
        */
        enum PROXY_TYPE
        {
        ...
        /*!
        * To access from perl, use, for example: <P>
        *  <tt>$x = $msparser::ms_connection_settings::HTTP_1_1</tt>
        *  </P><BR>
        */
        enum HTTP_PROTOCOL
        {
        ...
        //! Destructor
	    virtual ~ms_connection_settings();
        ...
        //! Returns the version of the http protocol to be used
