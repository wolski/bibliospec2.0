...
#                                                                            #
##############################################################################
 * @(#)$Source: /export/cvsroot/parser/inc/ms_quant_ratio.hpp,v $
 * @(#)$Revision: 1.4 $
...
namespace matrix_science {
    ...
    //! Represent "ratioType" type for "report_ratio" element from quantitation.xml
    ...
    public:
        ...
        //! Returns a number of nested numerators
        ...
        //! Returns a numerator object by its number
        const ms_quant_numerator * getNumeratorByNumber(const int idx) const;

        //! Returns a numerator object by its name or NULL in case of not found
        ...
        //! Returns a denominator object by its number
        const ms_quant_numerator * getDenominatorByNumber(const int idx) const;

        //! Returns a denominator object by its name or NULL in case of not found
